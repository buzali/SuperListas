...
#define STACK_USE_GENERIC_TCP_CLIENT_EXAMPLE	// HTTP Client example in TCPClient.c
...
#define MY_DEFAULT_MAC_BYTE2            (0x1E)	// if using an ENCX24J600, MRF24WB0M, or
#define MY_DEFAULT_MAC_BYTE3            (0xC0)	// PIC32MX6XX/7XX internal Ethernet
#define MY_DEFAULT_MAC_BYTE4            (0x03)	// controller and wish to use the
#define MY_DEFAULT_MAC_BYTE5            (0xF7)	// internal factory programmed MAC
#define MY_DEFAULT_MAC_BYTE6            (0x6F)	// address instead.
